...
// www.poromean.com/
$crawler_poromean = $client->request('GET', 'https://www.poromean.com/archives/author/dara');

$links = $crawler_poromean->filter('div.td-module-thumb > a')->each(function($node_link){
