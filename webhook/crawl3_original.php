...
$proxies = explode("\n", file_get_contents('/var/www/khmernewslive_original/webhook/proxies.txt'));
...
// camnews.asia
$crawler_camnewsasia = $client->request('GET', 'https://camnews.asia/archives/category/news/local-news');

$links = $crawler_camnewsasia->filter('h2.post-title.entry-title > a')->each(function($node_link){
