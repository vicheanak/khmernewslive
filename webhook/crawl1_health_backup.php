...
require( '/var/www/khmernewshealth/wp-load.php' );
require_once('/var/www/khmernewshealth/wp-admin/includes/media.php');
require_once('/var/www/khmernewshealth/wp-admin/includes/file.php');
require_once('/var/www/khmernewshealth/wp-admin/includes/image.php');
...
$proxies = explode("\n", file_get_contents('/var/www/khmernewshealth/webhook/proxies.txt'));
...
$crawl_links = array(
	array(
		'link' => 'http://kanha.sabay.com.kh/topics/health',
		...
		'tag_input' => array('Kanha'),
		'feature_image_filter' => 'div.post_content > .detail > .content-grp-img > img'
	),
	array(
		'link' => 'http://news.sabay.com.kh/article/tag/healthy-life',
		'href_filter' => '#posts_list a',
		'title_filter' => '.title.detail > p',
		'post_category' => 36,
		'content_filter' => 'div.post_content > .detail > p',
	...
	array(
		'link' => 'http://www.topnews4khmer.com/category/សុខភាព-និងសម្រស់',
