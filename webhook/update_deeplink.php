...
foreach($custom_posts as $post) : setup_postdata($post);
	...
	$post_content = mb_substr($post_content, 3, 70, "UTF-8");
	...
	// $ch = curl_init('https://api.branch.io/v1/url?url='.$app_link);
	...
	// echo $GLOBALS['post_id'] . " + " . $GLOBALS['my_post']['post_title']." + ".$app_link->url . " | ";
