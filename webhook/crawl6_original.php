...
// kbn.news/
$crawler_kbnnews = $client->request('GET', 'https://kbn.news');

$links = $crawler_kbnnews->filter('div.td-block-span6 div.item-detail h3.entry-title.td-module-title > a')->each(function($node_link){
