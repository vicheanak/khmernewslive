<?php
if (!function_exists('newsport_front_page_main_section_2')) :
    /**
     * Banner Slider
     *
     ...
     *
     */
    function newsport_front_page_main_section_2()
    {
...
add_action('covernews_action_front_page_main_section_2', 'newsport_front_page_main_section_2', 40);